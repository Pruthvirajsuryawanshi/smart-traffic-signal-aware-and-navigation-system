...
// ONLY SIG-101 to SIG-103 - INT-1 signals
const char* MY_SIGNALS[] = {"SIG-101", "SIG-102", "SIG-103"};
const int MY_SIGNAL_COUNT = 3;
...
SignalPins signals[] = {
  {"SIG-101", SIG101_GREEN, SIG101_YELLOW, SIG101_RED},
  {"SIG-102", SIG102_GREEN, SIG102_YELLOW, SIG102_RED},
  {"SIG-103", SIG103_GREEN, SIG103_YELLOW, SIG103_RED}
};
...
void setup() {
  ...
  server.begin();
  Serial.println("INT-1 ISOLATED MODE - Ready");
  Serial.println("This ESP32 ONLY controls SIG-101 to SIG-103");
}
