...
const HardwareStatusBanner = ({ hardware }: Props) => {
  ...
  return (
    <div className="rounded-md border border-signal-yellow/50 bg-signal-yellow/10">
      <div className="flex items-center gap-2 px-3 py-2">
        <AlertTriangle className="h-3.5 w-3.5 shrink-0 text-signal-yellow" />
        ...
        <button
          ...
          className="flex items-center gap-1 rounded px-1.5 py-0.5 text-[10px] font-medium text-muted-foreground transition-colors hover:bg-foreground/5 hover:text-foreground"
      ...
      {!collapsed && (
        <div className="border-t border-signal-yellow/30 px-3 pb-2 pt-2">
